...
LD_LIBRARY_PATH=./:/usr/local/lib java -classpath ./okuyamaFuse-0.0.2.jar:./fuse-j.jar:./commons-logging-1.0.4.jar:./okuyama-0.9.6.1.jar:./javamail-1.4.1.jar:./log4j-1.2.14.jar \
